...
public class MainP1 {
	public static void main(String[] args) throws FileNotFoundException {
		...
		Viewer.showPanelInFrame(v1, "P1.Viewer 1", 100, 50);
		Viewer.showPanelInFrame(v2, "P1.Viewer 2", 450, 50);
		Viewer.showPanelInFrame(v3, "P1.Viewer 3", 800, 200);
		...
		ipManager.addMessageProducer(getArrayProducer(5,100));
    ...
    private static ArrayProducer getArrayProducer(int times, int delay) {
    	Message[] messages = {
				new Message("UP",				 new ImageIcon("images/new1.jpg")),
...
class ShowGubbe implements MessageProducer {
	...
	public Message nextMessage() {
		return new Message("Hej folks...",new ImageIcon("images/gubbe.jpg"));
	}
}